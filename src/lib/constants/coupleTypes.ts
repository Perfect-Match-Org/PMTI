...
export const COUPLE_TYPES: Record<CoupleTypeCode, CoupleTypeDefinition> = {
  [CoupleTypeCode.ADVENTUROUS_PLANNERS]: {
    ...
    description: {
      summary: "You both love exploring new places and making detailed plans for your adventures. You're the couple with the shared Pinterest board full of travel destinations and the Google Sheets itinerary for every trip.",
      traits: ["Organized", "Adventurous", "Future-focused", "Detail-oriented"],
      strengths: ["Great at planning trips", "Always trying new things", "Good at researching and preparing"],
      challenges: ["Might over-plan spontaneous moments", "Could stress about sticking to schedules"],
      conflictResolution: {
        style: "Talk through issues with a plan",
        tips: ["Create a 'discussion agenda' when addressing conflicts", "Plan regular check-ins about your relationship"]
      },
      loveLanguages: {
  ...
  [CoupleTypeCode.COZY_HOMEBODIES]: {
    ...
    description: {
      ...
      strengths: ["Create a warm, welcoming home environment", "Great at being present with each other", "Low-maintenance relationship needs"],
      ...
      conflictResolution: {
        ...
        tips: ["Have difficult conversations at home where you feel safe", "Create cozy spaces for regular relationship talks"]
      },
      loveLanguages: {
  ...
  [CoupleTypeCode.SOCIAL_BUTTERFLIES]: {
    ...
    description: {
      ...
      strengths: ["Great at networking together", "Always have weekend plans", "Bring out the best in each other socially"],
    },
    graphic: {
  ...
  [CoupleTypeCode.THOUGHTFUL_DEEP_THINKERS]: {
    ...
    description: {
      ...
      strengths: ["Have meaningful conversations", "Support each other's personal growth", "Think before acting"],
    },
    graphic: {
  ...
  [CoupleTypeCode.BALANCED_PARTNERS]: {
    ...
    description: {
      ...
      strengths: ["Complement each other's weaknesses", "Create stability together", "Handle different situations well"],
    },
    graphic: {
  ...
  [CoupleTypeCode.CREATIVE_COLLABORATORS]: {
    ...
    graphic: { iconUrl: "/icons/creative-collaborators.svg", colorScheme: { primary: "#7C3AED", secondary: "#DB2777", accent: "#F59E0B" }}
  },
  ...
  [CoupleTypeCode.SUPPORTIVE_COMPANIONS]: {
    ...
    description: { summary: "...", traits: [], strengths: [] },
    graphic: { iconUrl: "/icons/supportive-companions.svg", colorScheme: { primary: "#059669", secondary: "#0891B2", accent: "#FACC15" }}
  },
  ...
  [CoupleTypeCode.AMBITIOUS_ACHIEVERS]: {
    ...
    description: { summary: "...", traits: [], strengths: [] },
    graphic: { iconUrl: "/icons/ambitious-achievers.svg", colorScheme: { primary: "#1E40AF", secondary: "#DC2626", accent: "#F59E0B" }}
  },
  ...
  [CoupleTypeCode.RELAXED_ROMANTICS]: {
    ...
    description: { summary: "...", traits: [], strengths: [] },
    graphic: { iconUrl: "/icons/relaxed-romantics.svg", colorScheme: { primary: "#DB2777", secondary: "#F97316", accent: "#7C3AED" }}
  },
  ...
  [CoupleTypeCode.INTELLECTUAL_EXPLORERS]: {
    ...
    description: { summary: "...", traits: [], strengths: [] },
    graphic: { iconUrl: "/icons/intellectual-explorers.svg", colorScheme: { primary: "#0F766E", secondary: "#1E40AF", accent: "#A21CAF" }}
  },
  ...
  [CoupleTypeCode.PRACTICAL_PARTNERS]: {
    ...
    description: { summary: "...", traits: [], strengths: [] },
    graphic: { iconUrl: "/icons/practical-partners.svg", colorScheme: { primary: "#7C2D12", secondary: "#059669", accent: "#F59E0B" }}
  },
  ...
  [CoupleTypeCode.PLAYFUL_COMPANIONS]: {
    ...
    description: { summary: "...", traits: [], strengths: [] },
    graphic: { iconUrl: "/icons/playful-companions.svg", colorScheme: { primary: "#FACC15", secondary: "#F97316", accent: "#7C3AED" }}
  },
  ...
  [CoupleTypeCode.MINDFUL_MATCHES]: {
    ...
    description: { summary: "...", traits: [], strengths: [] },
    graphic: { iconUrl: "/icons/mindful-matches.svg", colorScheme: { primary: "#65A30D", secondary: "#0F766E", accent: "#A21CAF" }}
  },
  ...
  [CoupleTypeCode.INDEPENDENT_TOGETHER]: {
    ...
    description: { summary: "...", traits: [], strengths: [] },
    graphic: { iconUrl: "/icons/independent-together.svg", colorScheme: { primary: "#1E40AF", secondary: "#059669", accent: "#EA580C" }}
  },
  ...
  [CoupleTypeCode.TRADITIONAL_SWEETHEARTS]: {
    ...
    description: { summary: "...", traits: [], strengths: [] },
    graphic: { iconUrl: "/icons/traditional-sweethearts.svg", colorScheme: { primary: "#DB2777", secondary: "#7C2D12", accent: "#FACC15" }}
  },
};
